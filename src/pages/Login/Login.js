            ...
            <div className='login__wrapper'>
                ...
                <div className='login__signIn-form'>
                    ...
                    <div className='login__signIn-form-bottom'>
                        <div className='login__facebook'> <FacebookIcon/> <span>Login with Facebook</span> </div>
                        <span>New to Netflix? <a href='/' className='login__signUpLink'>Sign up now.</a> </span> 
                        <p>
                            This page is protected by Google reCAPTCHA to ensure
                            you're not a bot. <a href='/' className='login__learnMore'>Learn more.</a>{' '}
                        </p>
                    </div>
                </div>
            </div>
